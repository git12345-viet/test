                        ...
                        <div class="hero__search">
                            <div class="hero__search__form">
                                <form action="customer">
                                    <input type="text" name="keywords" placeholder="Search for food">
                                            ...
                                            <div class="featured__item">
                                                <div class="featured__item__pic set-bg" data-setbg="${p.getImage()}">
                                                    <ul class="featured__item__pic__hover">
                                                        <li><a href="cart?service=addToCart&productId=${p.getID()}"><i class="fa fa-shopping-cart"></i></a></li>
                                                    </ul>

                                                </div>  
                                                <div class="featured__item__text">
                                                    <h6>
                                                        <a href="customer?service=getProductDetail&productId=${p.getID()}" onmouseover="changeStyle(this, true)" onmouseout="changeStyle(this, false)">
                                                            ${p.getName()}
                                                        </a>
                                                    </h6>
