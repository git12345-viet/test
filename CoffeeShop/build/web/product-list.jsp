                                ...
                                <tbody>
                                    <c:forEach items="${vectorP}" var="p">
                                        <tr>
                                            ...
                                            <td>${p.price} VND</td>
                                            <td>
                                                <a href="productmanager?service=displayproduct&productId=${p.ID}">
                                                    Edit |
                                                </a>
        ...
        <script>
            function confirmDelete(productID) {
                if (confirm("Are you sure you want to delete this product?")) {
                    ...
                    window.location.href = "productmanager?service=delete&productId=" + productID;
                }
            }
        </script>
