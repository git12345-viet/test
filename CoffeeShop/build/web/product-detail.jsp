                            ...
                            <div class="hero__search">
                                <div class="hero__search__form">
                                    <form action="content" method="post">
                                        <input type="text" name="txt" placeholder="Search for food">
                            ...
                            <aside class="col-sm-7">
                                <article class="card-body p-5">
                                    ...
                                    <dl class="item-property">      
                                        <dd><p style="color: black">Category: ${cate.name}</p></dd>
                                        <dd><p style="color: black">Availibility: In Stock</p></dd>
                                        <dd><p style="color: black">${product.getDescription()}</p></dd>
                                        <dd><p style="color: red">${product.getPrice()} VND</p></dd>
                                ...
                                <div class="col-lg-4 col-md-6 text-center">
                                    <div class="single-product-item">
                                        <div class="product-image">
                                            <a href="customer?service=getProductDetail&productId=${p.getID()}"><img style="width: 100px;" src="${p.image}" alt="product_image"></a>
                                        </div>
                                        <h3>${p.name}</h3>
