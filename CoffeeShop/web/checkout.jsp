                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="checkout__order">
                                ...
                                <div class="checkout__order-products">Item <span>Check</span></div>
                                <ul class="checkout__order-list">
                                <c:forEach items="${cart.cartItems}" var="entry">
                                    <li class="checkout__order-item">
                                        <input type="text" value="${entry.key.getName()}" readonly class="checkout__order-item-name">
                                        <input type="text" name="quantity" value="${entry.value} x ${entry.key.getPrice()}_VND" readonly class="checkout__order-item-price">
                                    </li>
                                </c:forEach>
                            </ul>
